...
{
  if(birthYear == ""){
   return "<font color='red' size='3'><i>Please enter a valid birthYear.</i></font>";
  }
  else if(currentYear == ""){
    return "<font color='red' size='3'><i>Please enter a valid current Year.</i></font>";
  }
  else{
...
// Task 2 - The Lifetime Supply Calculator
 ...
 {
   if(age == ""){
    return "<font color='red' size='3'><i>Please enter a valid age.</i></font>";
   }
   else if(amount == ""){
    return "<font color='red' size='3'><i>Please enter a valid amount.</i></font>";
   }
   if(age >= MAX_AGE){
     return "<font color='red' size='3'><i>Please enter an age less than the maximum age("+MAX_AGE+").</i></font>";
   }
   else{   
 ...
 {
    if(radius ==""){
	 return "<font color='red' size='3'><i>Please enter a valid radius.</i></font>";
	}
	else{
 ...
 {
    if(tempCelsius ==""){
	 return "<font color='red' size='3'><i>Please enter a valid temperature for conversion.</i></font>";
	}
	else{
